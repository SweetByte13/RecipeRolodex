        ...
        <div>
            ...
            <main>
                <div className="home-background-banner">
                    <Container>
                        <Row className="align-items-center">
                            <Col xs={12} md={6} className="left-p-on-home">
                            ...
                            <Col xs={12} md={6}>
                                <img className="home-images" src={cauli_salad} alt="Cauliflower Salad" />
                            </Col>
                        </Row>
                    </Container>
                </div>
                <Container>
                    <Row className="align-items-center">
                        <Col xs={12} md={6}>
                            <img className="home-images" src={peaches} alt="Peaches" />
                        </Col>
                        <Col xs={12} md={6} className="right-p-on-home">
                ...
                <div className="home-background-banner">
                    <Container>
                        <Row className="align-items-center">
                            ...
                            <Col xs={12} md={6}>
                                <img className="home-images" src={curry} alt="Curry" />
                            </Col>
                        </Row>
                    </Container>
                </div>
                <Container>
                    <Row className="align-items-center">
                        <Col xs={12} md={6}>
                            <img className="home-images" src={smothered_fries} alt="Smothered Fries" />
                        </Col>
                        <Col xs={12} md={6} className="right-p-on-home">
                ...
                <Container>
                    <Row className="align-items-center">
                        <Col xs={12} md={6}>
                            <img className="home-images" src={cherry_cake} alt="Cherry Cake" />
                        </Col>
                        <Col xs={12} md={6} className="right-p-on-home">
